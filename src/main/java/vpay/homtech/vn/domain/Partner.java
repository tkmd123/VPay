...
public class Partner implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Wallet> partners = new HashSet<>();
    @OneToMany(mappedBy = "partner")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<PartnerLog> partners = new HashSet<>();
    @OneToMany(mappedBy = "partner")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<PartnerTransaction> partners = new HashSet<>();
    ...
    public Set<Wallet> getPartners() {
        return partners;
    }

    public Partner partners(Set<Wallet> wallets) {
        this.partners = wallets;
        return this;
    }

    public Partner addPartner(Wallet wallet) {
        this.partners.add(wallet);
        wallet.setPartner(this);
        return this;
    }

    public Partner removePartner(Wallet wallet) {
        this.partners.remove(wallet);
        wallet.setPartner(null);
        return this;
    }

    public void setPartners(Set<Wallet> wallets) {
        this.partners = wallets;
    }
    ...
    public Set<PartnerTransaction> getPartners() {
        return partners;
    }

    public Partner partners(Set<PartnerTransaction> partnerTransactions) {
        this.partners = partnerTransactions;
        return this;
    }

    public Partner addPartner(PartnerTransaction partnerTransaction) {
        this.partners.add(partnerTransaction);
        partnerTransaction.setPartner(this);
        return this;
    }

    public Partner removePartner(PartnerTransaction partnerTransaction) {
        this.partners.remove(partnerTransaction);
        partnerTransaction.setPartner(null);
        return this;
    }

    public void setPartners(Set<PartnerTransaction> partnerTransactions) {
        this.partners = partnerTransactions;
    }
