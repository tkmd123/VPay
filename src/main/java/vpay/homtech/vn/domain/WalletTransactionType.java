...
@Document(indexName = "wallettransactiontype")
public class WalletTransactionType implements Serializable {
    ...
    @NotNull
    @Column(name = "wallet_trans_type_code", nullable = false)
    ...
    public WalletTransactionType walletTransTypes(Set<WalletTransaction> walletTransactions) {
        this.walletTransTypes = walletTransactions;
        return this;
    }

    public WalletTransactionType addWalletTransType(WalletTransaction walletTransaction) {
        this.walletTransTypes.add(walletTransaction);
        walletTransaction.setWalletTransactionType(this);
        return this;
    }

    public WalletTransactionType removeWalletTransType(WalletTransaction walletTransaction) {
