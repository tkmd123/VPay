...
public class WalletRuleRateResource {
    ...
    @Timed
    public ResponseEntity<WalletRuleRate> createWalletRuleRate(@RequestBody WalletRuleRate walletRuleRate) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<WalletRuleRate> updateWalletRuleRate(@RequestBody WalletRuleRate walletRuleRate) throws URISyntaxException {
