...
public class WalletTransactionResource {
    ...
    @Timed
    public ResponseEntity<List<WalletTransaction>> searchWalletTransactions(@RequestParam String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generateSearchPaginationHttpHeaders(query, page, "/api/_search/wallet-transactions");
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
