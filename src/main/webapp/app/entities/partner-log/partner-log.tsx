...
export interface IPartnerLogState {
  search: string;
}
...
export class PartnerLog extends React.Component<IPartnerLogProps, IPartnerLogState> {
  ...
  render() {
    const { partnerLogList, match } = this.props;
    return (
      <div>
        ...
        <div className="table-responsive">
          <Table responsive>
            <thead>
              <tr>
                <th>ID</th>
                <th>Partner Log Amount</th>
                <th>Partner Log Trans Ref</th>
                <th>Partner Log Username</th>
                <th>Partner Log Product Type Code</th>
                <th>Partner Log Result Code</th>
                <th>Partner Log Result Desc</th>
                <th>Partner Log Date</th>
                <th>Partner Log UDF 1</th>
                <th>Partner Log UDF 2</th>
                <th>Partner Log UDF 3</th>
                <th>Partner Log UDF 4</th>
                <th>Partner Log UDF 5</th>
                <th>Partner</th>
                <th />
              </tr>
            </thead>
