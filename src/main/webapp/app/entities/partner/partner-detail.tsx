      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            ...
            <dt>
              <span id="partnerAPIUsername">Partner API Username</span>
            </dt>
            <dd>{partnerEntity.partnerAPIUsername}</dd>
            <dt>
              <span id="partnerAPIPassword">Partner API Password</span>
            </dt>
            <dd>{partnerEntity.partnerAPIPassword}</dd>
            <dt>
              <span id="partnerUDF1">Partner UDF 1</span>
            </dt>
            <dd>{partnerEntity.partnerUDF1}</dd>
            <dt>
              <span id="partnerUDF2">Partner UDF 2</span>
            </dt>
            <dd>{partnerEntity.partnerUDF2}</dd>
            <dt>
              <span id="partnerUDF3">Partner UDF 3</span>
            </dt>
