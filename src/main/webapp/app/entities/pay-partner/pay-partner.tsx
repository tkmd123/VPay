      ...
      <div>
        <h2 id="pay-partner-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp; Create new Pay Partner
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('payPartnerCode')}>
                    Pay Partner Code <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('payPartnerName')}>
                    Pay Partner Name <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('payPartnerDesc')}>
                    Pay Partner Desc <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('payPartnerUDF1')}>
                    Pay Partner UDF 1 <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('payPartnerUDF2')}>
                    Pay Partner UDF 2 <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('payPartnerUDF3')}>
                    Pay Partner UDF 3 <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
