...
export class WalletRuleUpdate extends React.Component<IWalletRuleUpdateProps, IWalletRuleUpdateState> {
  ...
  render() {
    const { walletRuleEntity, walletTypes, payPartners, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="vPayApp.walletRule.home.createOrEditLabel">Create or edit a WalletRule</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : walletRuleEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="wallet-rule-walletRuleCode" type="text" name="walletRuleCode" />
                </AvGroup>
                <AvGroup>
                  <Label id="walletRuleNameLabel" for="walletRuleName">
                    Wallet Rule Name
                  </Label>
                  <AvField id="wallet-rule-walletRuleName" type="text" name="walletRuleName" />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  ...
                  <AvInput id="wallet-rule-walletType" type="select" className="form-control" name="walletType.id">
                    <option value="" key="0" />
                    {walletTypes
