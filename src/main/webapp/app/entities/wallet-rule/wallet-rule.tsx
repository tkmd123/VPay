...
import { getSearchEntities, getEntities, reset } from './wallet-rule.reducer';
...
export interface IWalletRuleState extends IPaginationBaseState {
  search: string;
}
