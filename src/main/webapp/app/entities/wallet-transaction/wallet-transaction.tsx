            ...
            <tbody>
              {walletTransactionList.map((walletTransaction, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {walletTransaction.walletTransctionType ? (
                      <Link to={`wallet-transction-type/${walletTransaction.walletTransctionType.id}`}>
                        {walletTransaction.walletTransctionType.id}
                      </Link>
                    ) : (
                      ''
                    )}
                  ...
                  <td>
                    {walletTransaction.walletAllotment ? (
                      <Link to={`wallet-allotment/${walletTransaction.walletAllotment.id}`}>{walletTransaction.walletAllotment.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
