...
public class PayPartnerResourceIntTest {
    ...
    private static final String DEFAULT_PAY_PARTER_DESC = "AAAAAAAAAA";
    private static final String UPDATED_PAY_PARTER_DESC = "BBBBBBBBBB";
    ...
    public static PayPartner createEntity(EntityManager em) {
        PayPartner payPartner = new PayPartner()
            ...
            .payParterDesc(DEFAULT_PAY_PARTER_DESC);
        return payPartner;
    }
    ...
    public void createPayPartner() throws Exception {
        ...
        assertThat(testPayPartner.getPayParterDesc()).isEqualTo(DEFAULT_PAY_PARTER_DESC);
    ...
    public void getAllPayPartners() throws Exception {
        ...
        restPayPartnerMockMvc.perform(get("/api/pay-partners?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].payParterDesc").value(hasItem(DEFAULT_PAY_PARTER_DESC.toString())));
    }
    ...
    public void getPayPartner() throws Exception {
        ...
        restPayPartnerMockMvc.perform(get("/api/pay-partners/{id}", payPartner.getId()))
            ...
            .andExpect(jsonPath("$.payParterDesc").value(DEFAULT_PAY_PARTER_DESC.toString()));
    }
    ...
    public void updatePayPartner() throws Exception {
        ...
        updatedPayPartner
            ...
            .payParterDesc(UPDATED_PAY_PARTER_DESC);
        ...
        assertThat(testPayPartner.getPayParterDesc()).isEqualTo(UPDATED_PAY_PARTER_DESC);
    ...
    public void searchPayPartner() throws Exception {
        // Initialize the database
        payPartnerRepository.saveAndFlush(payPartner);
        when(mockPayPartnerSearchRepository.search(queryStringQuery("id:" + payPartner.getId())))
            .thenReturn(Collections.singletonList(payPartner));
